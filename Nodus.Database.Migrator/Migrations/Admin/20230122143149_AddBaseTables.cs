...
namespace Nodus.Database.Migrations.Migrations.Admin
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectionString = table.Column<string>(type: "varchar(512)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleFeatures", x => new { x.FeatureID, x.RoleID });
                    table.ForeignKey(
